...
try {
 ...
 const randomPrompt = getRandomPrompt(form.target);
 setForm({ ...form, prompt:randomPrompt })
  ...
  return (
   ...
   <div>
        ...
        mx-w-[500px]'>Create imaginative
        and visually stunning images through by Dall-E AI and share them with the
         community</p>
    </div>
    ...
    <form className='mt-16 max-w-3x1' onSubmit={handleSubmit}>
     <div className='flex flex-col gap-5'>
      ...
      <FormField 
       ...
       type="text"
       name="prompt"
       placeholder="A plush toy robot sitting against 
       a yellow wall"  
       value={form.prompt}
       handleChange={handleChange}
       isSurpriseMe
